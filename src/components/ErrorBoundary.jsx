  ...
  render() {
    ...
    return (
      <div style={{ minHeight: '100svh', display: 'grid', placeItems: 'center', background: '#2B3036', color: '#FFFFFF', padding: 32, textAlign: 'center' }}>
        <div>
          <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 12, fontWeight: 600, letterSpacing: '0.2em', color: '#7DB200', marginBottom: 16 }}>AKALKA / INTERRUPTED</p>
          <p style={{ fontFamily: "'Comfortaa', 'Montserrat', sans-serif", fontWeight: 700, fontSize: 'clamp(1.7rem,4vw,2.8rem)', lineHeight: 1.15, marginBottom: 12 }}>Something failed to render.</p>
